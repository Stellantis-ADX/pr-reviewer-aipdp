...
class Options:
    def __init__(
        ...
        self.light_model_name_claude = light_model_name_claude
        self.heavy_model_name_claude = heavy_model_name_claude
        self.light_token_limits_claude = TokenLimits(light_model_name_claude) if light_model_name_claude else None
        self.heavy_token_limits_claude = TokenLimits(heavy_model_name_claude) if heavy_model_name_claude else None
    ...
    def print(self) -> None:
        ...
        # Databricks Claude
        info(f"databricks_base_url: {self.databricks_base_url}")
        if self.databricks_token:
            info(f"databricks_token: ****************")
        else:
            info(f"databricks_token: {self.databricks_token}")
        info(f"light_model_name_claude: {self.light_model_name_claude}")
        info(f"heavy_model_name_claude: {self.heavy_model_name_claude}")
